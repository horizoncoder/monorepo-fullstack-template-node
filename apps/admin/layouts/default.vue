    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 dark:bg-gray-950 border-r border-gray-800 flex flex-col">
      ...
      <div class="h-16 flex items-center px-6 border-b border-gray-800">
        <div class="flex items-center gap-3">
          <div class="w-8 h-8 rounded-lg bg-primary flex items-center justify-center text-primary-foreground font-bold text-sm">A</div>
        ...
        <div class="h-full flex items-center justify-end px-6 gap-4">
          <div v-if="currentAdmin" class="relative">
            ...
            >
              ...
              <span class="text-sm font-medium text-foreground">{{ currentAdmin.name }}</span>
            ...
            >
              <div class="px-4 py-2 border-b border-border">
                <p class="text-sm font-medium text-foreground">{{ currentAdmin.name }}</p>
                <p class="text-xs text-muted-foreground">{{ currentAdmin.email }}</p>
              </div>
